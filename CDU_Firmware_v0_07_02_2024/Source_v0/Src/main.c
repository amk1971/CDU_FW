...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : MCU_DSR4_Pin RIGHT_SW4_Pin RIGHT_SW3_Pin RIGHT_SW2_Pin
                           RIGHT_SW1_Pin GP_SW4_Pin GP_SW3_Pin */
  GPIO_InitStruct.Pin = MCU_DSR4_Pin|RIGHT_SW4_Pin|RIGHT_SW3_Pin|RIGHT_SW2_Pin
                          |RIGHT_SW1_Pin|GP_SW4_Pin|GP_SW3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
