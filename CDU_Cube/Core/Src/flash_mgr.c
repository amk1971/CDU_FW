...
{	
	...
	spif_WriteRecord((recordtype_t*)&defaultrecord, index);	// cast as uint8 array to stream bytes to flash
}								
...
//  STORE SYSTEM STATE								
//								
/*! \fn void spif_Store_SysState(systemstate_t *s, , uint16_t sector)								
...
*/								
//-------------------------------------------------------------------								
void spif_Store_SysState(systemstate_t *s /* Pointer to systemstate_t object */, uint16_t sector /* destination sector number */)						
{								
...
//  LOAD SYSTEM STATE								
//								
/*! \fn void spif_Load_SysState(systemstate_t *s,uint16_t sector)								
\brief Load System State parameters from Flash								
								
Read struct from Flash and copy to systemstate_t object passed as reference								
\return None								
*/								
//-------------------------------------------------------------------								
void spif_Load_SysState(systemstate_t *s /* Pointer to systemstate_t object to write data to */, uint16_t sector /* source sector number */)								
{								
