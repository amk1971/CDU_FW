...
#define PARAMETER_FLASH_PAGE          0                 // Page for s_HF_Parameters
...
#define CHANNEL_FLASH_PAGE          2                 // Page for storing standby frequencies
#define CHANNEL_FLASH_ADDRESS       BY25Q16BS_PAGE_ADDRESS(CHANNEL_FLASH_PAGE) // Address: 0x000100
#define CHANNELS_PER_PAGE          (BY25Q16BS_PAGE_SIZE / sizeof(float)) // 64 frequencies per page

// General Macros for Flash
#define FLASH_PAGE_ADDRESS(page)      (BY25Q16BS_START_ADDRESS + ((page) * BY25Q16BS_PAGE_SIZE))

#define NUM_CHANNELS_PER_PAGE 20
