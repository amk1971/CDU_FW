...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = BOOTLOAD_TX_Pin|BOOTLOAD_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = MCU_TX4_Pin|MCU_RX4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /* USER CODE END USART5_MspInit 0 */
    ...
    PE11     ------> USART5_RX
    */
    GPIO_InitStruct.Pin = MCU_TX3_Pin|MCU_RX3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /* USER CODE END USART6_MspInit 0 */
    ...
    PA5     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = MCU_TX2_Pin|MCU_RX2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, BOOTLOAD_TX_Pin|BOOTLOAD_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, MCU_TX4_Pin|MCU_RX4_Pin);
  ...
  /* USER CODE END USART5_MspDeInit 0 */
    ...
    PE11     ------> USART5_RX
    */
    HAL_GPIO_DeInit(GPIOE, MCU_TX3_Pin|MCU_RX3_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PA5     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOA, MCU_TX2_Pin|MCU_RX2_Pin);
