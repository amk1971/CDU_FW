...
#define MCU_RX2_Pin GPIO_PIN_11
#define MCU_RX2_GPIO_Port GPIOC
#define MCU_TX2_Pin GPIO_PIN_12
#define MCU_TX2_GPIO_Port GPIOC
...
#define MCU_RX2D2_Pin GPIO_PIN_2
#define MCU_RX2D2_GPIO_Port GPIOD
#define RELAY1_Pin GPIO_PIN_3
#define RELAY1_GPIO_Port GPIOD
#define MCU_DTR1_Pin GPIO_PIN_4
#define MCU_DTR1_GPIO_Port GPIOD
#define MCU_TX3_Pin GPIO_PIN_5
#define MCU_TX3_GPIO_Port GPIOD
#define MCU_RX3_Pin GPIO_PIN_6
