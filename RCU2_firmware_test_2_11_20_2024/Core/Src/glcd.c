...
void send_byte_2_LCD(uint8_t thebyte) {
	...
	if (thebyte & 0x01) LCD_DB0_HIGH;
	else LCD_DB0_LOW;	
	if (thebyte & 0x02) LCD_DB1_HIGH;
	else LCD_DB1_LOW;	
	if (thebyte & 0x04) LCD_DB2_HIGH;
	else LCD_DB2_LOW;	
	if (thebyte & 0x08) LCD_DB3_HIGH;
	else LCD_DB3_LOW;	
	if (thebyte & 0x10) LCD_DB4_HIGH;
	else LCD_DB4_LOW;	
	if (thebyte & 0x20) LCD_DB5_HIGH;
	else LCD_DB5_LOW;	
	if (thebyte & 0x40) LCD_DB6_HIGH;
	else LCD_DB6_LOW;	
	if (thebyte & 0x80) LCD_DB7_HIGH;
	else LCD_DB7_LOW;
}
